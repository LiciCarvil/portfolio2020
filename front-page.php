<?php get_header(); ?>
        <div data-scroll >
            ...
            <section class="smContainer introBlock panel" data-color="pinkLight">
                <div class="textBlock">
            ...
            <section class="bgContainer projectsBlock panel" data-color="pinkMedium">
                ...
                <div class="projectsBody">
                            ...
                            <div class="project">
                                <a href="<?php the_permalink(); ?>">
                                    <span>01</span>
                                    <div class="imageWrap">
                                        <img class="innerImage" src= "<?= $thumbnail ?>" data-scroll-zoom>
                                    </div>
            ...
            <section class="smContainer contactBlock panel" data-color="pinkLight">
